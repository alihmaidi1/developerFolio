...
const init = () => {
  ...
  objects = {
    base: resource.scene.children.find(
      (child: Object3D) => child.name === "base",
    ),
    shine: resource.scene.children.find(
      (child: Object3D) => child.name === "shine",
    ),
    display: resource.scene.children.find(
      (child: Object3D) => child.name === "display",
    ),
    electric: resource.scene.children.find(
      (child: Object3D) => child.name === "electric",
    ),
  };
