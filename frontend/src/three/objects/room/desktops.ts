...
const setupMesh = () => {
  ...
  const desktop1 = resource.scene.children.find(
    (child: Object3D) => child.name === "desktop-plane-0",
  );
  const desktop2 = resource.scene.children.find(
    (child: Object3D) => child.name === "desktop-plane-1",
  );
  ...
  const scrollIntensity1 = new Float32Array(
    desktop1.geometry.attributes.position.count,
  ).fill(1);
  const scrollIntensity2 = new Float32Array(
    desktop2.geometry.attributes.position.count,
  ).fill(0);
  desktop1.geometry.setAttribute(
    "scrollIntensity",
    new BufferAttribute(scrollIntensity1, 1),
  );
  desktop2.geometry.setAttribute(
    "scrollIntensity",
    new BufferAttribute(scrollIntensity2, 1),
  );

  // add messageIntensity attribute to geometries
  const messageIntensity1 = new Float32Array(
    desktop1.geometry.attributes.position.count,
  ).fill(0);
  const messageIntensity2 = new Float32Array(
    desktop2.geometry.attributes.position.count,
  ).fill(1);
  desktop1.geometry.setAttribute(
    "messageIntensity",
    new BufferAttribute(messageIntensity1, 1),
  );
  desktop2.geometry.setAttribute(
    "messageIntensity",
    new BufferAttribute(messageIntensity2, 1),
  );
...
const showMessage = () => {
  ...
  messageTween = gsap.fromTo(
    uniforms.uMessageIntensity,
    { value: 1 },
    { value: 0, duration: 1, delay: 2 },
  );
};
